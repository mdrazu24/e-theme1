<nav class="navbar p-0  bg-light border">
    ...
    <div class="container">
        <div class=" w-100  d-flex py-2 fs-6 justify-content-between text-gray-600 ">
        ...
        <div class="row w-100 justify-content-between  ">
            ...
            <form class="d-flex col-12 col-md-7 align-items-center justify-content-center" role="search">
            ...
            <div class="col-12 col-md-3 d-flex justify-content-around  align-items-center ">
                ...
                <a class="btn btn-primary">Login / Signup</a>

            </div>
        </div>
        <div class="w-100 px-5 d-flex py-2 ">
